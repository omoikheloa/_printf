...
int print_rot13string(va_list args_list, char buffer[], int flags, int width, int precision, int size);
int print_reverse(va_list args_list, char buffer[], int flags, int width, int precision, int size);
int print_pointer(va_list args_list, char buffer[], int flags, int width, int precision, int size);
int print_non_printable(va_list args_list, char buffer[], int flags, int width, int precision, int size);
int print_hexa(va_list args_list, char map_to[], char buffer[], int flags, char flag_ch, int width, int precision, int size);
